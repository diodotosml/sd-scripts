...
class NetworkTrainer:
    ...
    def train(self, args):
        ...
        if args.dataset_class is None:
            blueprint_generator = BlueprintGenerator(ConfigSanitizer(True, True, args.masked_loss or args.reg_image_training, True))
            if use_user_config:
                    ...
                    with accelerator.accumulate(network):
                       ...
                       #    )
                        ...
                        if args.direct_noise_prediction:
                            ...
                            loss = torch.nn.functional.mse_loss(cond_latents,  train_util.get_latent_from_noisy_latent(noise_scheduler, noisy_latents, noise_pred, timesteps).to(accelerator.device, dtype=weight_dtype), reduction="none")
                        else:
